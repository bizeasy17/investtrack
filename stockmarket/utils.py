...
from .models import CompanyBalanceSheet, CompanyDailyBasic, CompanyTop10FloatHolders, StockNameCodeMap
...
def collect_top10_holders(ts_code):
    try:
        ...
        for company in companies:
            ...
            # print(str(list_year)+'0101')
            # print(str(end_year)+'1231')
            # print(company.top10_holder_date.strftime('%Y%m%d'))
