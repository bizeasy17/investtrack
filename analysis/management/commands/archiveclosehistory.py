    ...
    try:
        if type == Command.CLOST_HISTORY:
            ...
            for hist in close_hist:
                shda = StockHistoryDailyArc(ts_code=hist.ts_code, trade_date=hist.trade_date, open=hist.open, high=hist.high,
            ...
            StockHistoryDailyArc.objects.bulk_create(hist_arc_list)
